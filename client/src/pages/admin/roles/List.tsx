...
import { RoleTableRow, RoleTableToolbar } from '../../../sections/admin/roles/list';
...
export default function RoleList() {
  ...
  const handleEditRow = (id: number) => {
    navigate(PATH_ADMINISTRATOR.roles.edit(paramCase(id.toString())));
  };

  const handleDuplicateRow = (id: number) => {
    navigate(PATH_ADMINISTRATOR.roles.duplicate(paramCase(id.toString())));
  };
        ...
        <HeaderBreadcrumbs
          ...
          action={
            <Button
              ...
              to={PATH_ADMINISTRATOR.roles.new}
            >
              New
            </Button>
          }
